...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private OAuth2User process(OAuth2UserRequest userRequest, OAuth2User user) {
        ...
        final var savedUser = userRepository.findByUserId(userInfo.getId());
        ...
        final var newUser = createUser(userInfo, providerType);
        return UserPrincipal.create(newUser, user.getAttributes());
    }
